defmodule InstagrainWeb.Router do
  use InstagrainWeb, :router

  import InstagrainWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {InstagrainWeb.Layouts, :root}
  ...
  if Application.compile_env(:instagrain, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: InstagrainWeb.Telemetry
  ...
  scope "/", InstagrainWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{InstagrainWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", InstagrainWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{InstagrainWeb.UserAuth, :ensure_authenticated}] do
