defmodule Instagrain.Accounts.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Instagrain.Repo)
  ...
  defp maybe_validate_unique_username(changeset, opts) do
    if Keyword.get(opts, :validate_username, true) do
      changeset
      |> unsafe_validate_unique(:username, Instagrain.Repo)
  ...
  """
  def valid_password?(%Instagrain.Accounts.User{hashed_password: hashed_password}, password)
  ...
  def avatar_changeset(user, attrs) do
    user
    |> cast(attrs, [:avatar_storage_key])
    |> validate_required([:avatar_storage_key])
  end
