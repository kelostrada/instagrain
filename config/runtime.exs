...
#
#     PHX_SERVER=true bin/instagrain start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :instagrain, InstagrainWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :instagrain, Instagrain.Repo,
    # ssl: true,
    url: database_url,
  ...
  host = System.get_env("PHX_HOST") || "insta.melinakrzemowa.pl"
  port = String.to_integer(System.get_env("PORT") || "4000")

  config :instagrain, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  config :instagrain, InstagrainWeb.Endpoint,
    ...
    http: [
      ...
      # See the documentation on https://hexdocs.pm/plug_cowboy/Plug.Cowboy.html#module-options
  ...
  config :instagrain, Instagrain.Mailer,
