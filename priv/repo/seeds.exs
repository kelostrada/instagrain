...
defmodule Instagrain.Seeds.Helpers do
  ...
  def random_hashtags(count) do
    tags = [
      "#photography", "#photooftheday", "#instagood", "#love", "#beautiful",
      "#nature", "#travel", "#art", "#happy", "#cute", "#fashion", "#style",
      "#food", "#fitness", "#selfie", "#sunset", "#cat", "#dog", "#pretty",
      "#summer", "#winter", "#friends", "#fun", "#life", "#mood",
      "#explore", "#adventure", "#wanderlust", "#vibes", "#blessed",
      "#ootd", "#throwback", "#goals", "#morning", "#coffee",
      "#weekend", "#chill", "#goodvibes", "#instadaily", "#picoftheday",
      "#landscape", "#sky", "#beach", "#mountains", "#city",
      "#street", "#architecture", "#portrait", "#flowers", "#aesthetic"
    ]
  ...
  def random_full_name do
    first_names = [
      ...
      "Ella", "Jack", "Chloe", "Daniel", "Aria", "Matthew", "Lily", "Owen",
      "Zoe", "Leo", "Nora", "David", "Riley", "Jackson", "Layla", "Samuel",
      "Grace", "Aiden", "Scarlett", "Joseph", "Stella", "Carter", "Violet",
      "Kai", "Aurora", "Mila", "Ellie", "Theo"
    ]
    ...
    last_names = [
      ...
      "Mitchell", "Campbell", "Roberts", "Carter", "Phillips", "Evans",
      "Turner", "Parker", "Collins", "Edwards", "Stewart", "Murphy", "Cook"
    ]
